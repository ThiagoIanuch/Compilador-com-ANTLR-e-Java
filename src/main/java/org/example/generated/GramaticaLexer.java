...
public class GramaticaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "T__6", "DEPURAR", "SE", 
			"SENAO", "PARA", "ENQUANTO", "IMPRIMIR", "LER", "SOMA", "SUBTRACAO", 
			"MULTIPLICACAO", "DIVISAO", "IGUAL", "DIFERENTE", "MAIOR_IGUAL", "MENOR_IGUAL", 
			"MAIOR", "MENOR", "ATRIBUICAO", "SAIDA", "ENTRADA", "TIPO_INTEIRO", "TIPO_DECIMAL", 
